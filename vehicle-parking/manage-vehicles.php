<?php
    ...
    if (strlen($_SESSION['vpmsaid']==0)) {
        ...
        if (isset($_POST['submit-vehicle'])) {
            ...
            // Insert vehicle information along with the hourly rate
            $query = mysqli_query($con, "INSERT INTO vehicle_info (ParkingNumber, VehicleCategory, VehicleCompanyname, RegistrationNumber, OwnerName, OwnerContactNumber, HourlyRate) 
                                         VALUES ('$parkingnumber', '$catename', '$vehcomp', '$vehreno', '$ownername', '$ownercontno', '$hourlyrate')");
