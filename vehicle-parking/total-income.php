					...
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="row progress-labels">
								<h1 class="col-md-12 text-center">PHP <?php include 'counters/income-count.php' ?></h1>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="row progress-labels">
								<h1 class="col-md-12 text-center">PHP <?php include 'counters/currentday-income.php' ?></h1>
								<!-- <div class="col-sm-6" style="text-align: right;">50%</div> -->
							</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="row progress-labels">
								<h1 class="col-md-12 text-center">PHP <?php include 'counters/yesday-income.php' ?></h1>
								<!-- <div class="col-sm-6" style="text-align: right;">50%</div> -->
							</div>
